# 基本配置
bark_id = '624ff79c28d6b300017cc1e8'  # bark app通知id
duration = 10  # 执行间隔时间秒
run_type = 2  # 监控类型 1首页监控(已经失效) 2购物车监控

# 首页get参数
key_word = '当前运力紧张，今天各时段已约满，敬请谅解'
station_id = '5a1e1664916edf414f8f84f9'  # 站点id
...
uid = '624ff79c28d6b300017cc1e8'  # ddmc-uid
api_version = '9.49.2'  # ddmc-api-version
build_version = '2.82.0'    # ddmc-build-version
raw_body = 'uid=624ff79c28d6b300017cc1e8&longitude=121.436511'
